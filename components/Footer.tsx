      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-1">
            <span className="text-xl font-bold tracking-tighter text-white mb-4 block">Global China</span>
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/60">
              <li>
                <a href="https://t.me/Managera_global" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                  Telegram: @Managera_global
                </a>
              </li>
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-xs text-white/40">
            <p>Copyright by Global China © {new Date().getFullYear()}.</p>
