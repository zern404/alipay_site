...
export const metadata: Metadata = {
  title: 'Политика использования cookies | Global China',
  description: 'Политика использования cookies на сайте Global China. Какие cookies мы используем и как вы можете управлять ими.',
  robots: {
    index: true,
    follow: true,
  },
...
const webPageData = {
  ...
  description: 'Политика использования cookies на сайте Global China',
